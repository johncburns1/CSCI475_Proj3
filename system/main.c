...
int	main(uint32 argc, uint32 *argv)
{
	...
	ready(create((void*) printpid, INITSTK, 6, "PRINTER-A", 2, 1, args1++), FALSE);
	ready(create((void*) printpid, INITSTK, 5, "PRINTER-B", 2, 1, args1++), FALSE);
	ready(create((void*) printpid, INITSTK, 12, "PRINTER-C", 2, 1, args1++), FALSE);
	ready(create((void*) printpid, INITSTK, 10, "PRINTER-D", 2, 1, args1++), FALSE);
	ready(create((void*) bigargs, INITSTK, 9, "BIGARGS", 2, 6, args2), FALSE);
